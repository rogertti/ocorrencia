<?php
    ...
    $msg = "Campo obrigat&oacute;rio vazio.";
        ...
        if(empty($_POST['idnota'])) { die("reload"); }
        ...
        if($filtro == 3) {
            try {
                ...
                $sql = $pdo->prepare("UPDATE nota SET datado = :datado, tecnico = :tecnico, texto = :texto WHERE idnota = :idnota");
                ...
                $sql->bindParam(':idnota', $_POST['idnota'], PDO::PARAM_INT);
                $res = $sql->execute();
