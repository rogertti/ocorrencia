                ...
                <div class="modal-body overing">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" id="idcliente" value="1673" class="form-control">
                            <input type="text" id="cliente" class="form-control" value="Fundo Municipal de Saúde de Camboriú" maxlength="255" title="Digite o nome do cliente" placeholder="Cliente" required readonly>
