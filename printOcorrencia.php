                    ...
                    <div class="col-xs-12">
                        <h2 class="page-header">
                            ...
                            <div class="pull-right text-right">
                                ...
                                <small><?php echo $cfg['endereco1'].' &#45; '.$cfg['endereco2']; ?></small><br>
                                <small><?php echo $cfg['telefone1'].' &#45; '.$cfg['telefone2'].' &#45; '.$cfg['site']; ?></small>
                            </div>
                        </h2>
                    </div>
                </div><!-- /.print-head -->
                    ...
                    <div class="col-xs-12">
                        <p>
                            <span class="pull-left">
                                <span>O cliente possui contrato? (&nbsp;&nbsp;) Sim (&nbsp;&nbsp;) N&atilde;o</span><br>
                                <span>A ocorr&ecirc;ncia foi paga? (&nbsp;&nbsp;) Sim (&nbsp;&nbsp;) N&atilde;o</span><br>
                                <span>Se sim, qual foi a forma de pagamento? (&nbsp;&nbsp;) Cart&atilde;o (&nbsp;&nbsp;) Dinheiro</span><br><br><br>
                                <span>Assinatura: _______________________________________</span><br>
                                <span style="font-size: 9px;">Ocorr&ecirc;ncia impressa em <?php echo date('d/m/Y') ?> &agrave;s <?php echo date('h:i:s'); ?></span>
                            </span>
                        </p>
                    </div>
                </div><!-- /.print-billet -->
