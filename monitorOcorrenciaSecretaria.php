<?php
    try {
        ...
        /*$tecnico = 'Vagner';
        $mostra = 'T';
        $sql = $pdo->prepare("SELECT idnota,datado,tecnico,texto FROM nota WHERE tecnico = :tecnico AND mostra = :mostra ORDER BY idnota DESC");
        $sql->bindParam(':tecnico', $tecnico, PDO::PARAM_STR);
                                        ...
                                        case -7:
                                            ...
                                            <tr>
                                                <td class="td-action-oc">
                                                    ...
                                                    <span><a data-toggle="modal" data-target="#edita-ocorrencia" title="Editar a ocorr&ecirc;ncia" href="editaOcorrenciaSaude.php?'.$pyidocorrencia.'='.$lin->idocorrencia.'"><i class="fa fa-pencil"></i></a></span>-->
                                                    <span>'.$imgitem.'</span>
                                                    <span>'.$imgstatus.'</span>
                                                </td>
        ...
        unset($sql,$ret,$py,$client,$fechada,$desativada);
    }
