...
$(document).ready(function () {
    ...
    $(".form-login").submit(function (e) {
	    ...
	    $.post("trustLogin.php", { usuario: usuario, senha: senha, rand: Math.random()}, function (data) {
            ...
            case 'saude':
                $.smkAlert({text: 'Login efetuado com sucesso.', type: 'success', time: 1});
                window.setTimeout("location.href='inicioSaude.php'", delay);
                break;
            
            case 'secretaria':
                $.smkAlert({text: 'Login efetuado com sucesso.', type: 'success', time: 1});
                window.setTimeout("location.href='inicioSecretaria.php'", delay);
                break;
