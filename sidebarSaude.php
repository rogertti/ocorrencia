...
<section class="sidebar">
    ...
    <?php
        switch($m) {
            case 1:
                echo'
                <li class="active"><a class="load-toggle" href="inicio.php" title="Clique para gerenciar as ocorr&ecirc;ncias"><i class="fa fa-file-text"></i> <span>In&iacute;cio</span></a></li>
